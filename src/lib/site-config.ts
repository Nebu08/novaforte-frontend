...
export const TEAM_MEMBERS: TeamMember[] = [
  ...
  },
  {
    ...
    roleEs: "COO",
    roleEn: "COO",
    descEs: "Director de procesos.",
    descEn: "Process Director.",
    initials: "DG",
    photo: "", // Sube tu foto a public/images/equipo/daniel.jpg y pon la ruta aquí
    linkedIn: "",
  },
  {
    name: "Sergio",
    roleEs: "Jefe de Diseño",
    roleEn: "Head of Design",
    descEs: "Líder de desarrollo y modelado paramétrico.",
    descEn: "Development and parametric modeling leader.",
    initials: "S",
    photo: "", // Sube tu foto a public/images/equipo/sergio.jpg y pon la ruta aquí
    linkedIn: "",
  },
];
