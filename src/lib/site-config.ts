...
export const MODELS_3D: Model3D[] = [
  ...
  {
    id: 8,
    nameEs: "Engranaje Helicoidal (Estudiantes Nivel 1)",
    nameEn: "Technical Helical Gear (Level 1 Students)",
  ...
  {
    id: 9,
    nameEs: "Mecanismo Didáctico (Estudiantes Nivel 1)",
    nameEn: "Didactic CAD Mechanism (Level 1 Students)",
  ...
  {
    id: 10,
    nameEs: "Componente de Relojería (Estudiantes Nivel 1)",
    nameEn: "Watchmaking Component (Level 1 Students)",
